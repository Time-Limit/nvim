...
wk.register(
  {
    ...
    ["<Leader>["] = { "<C-o>", noremap = true, "move to the previous position" },
    ["<Leader>]"] = { "<C-i>", noremap = true, "move to the next position" },
  }
)
...
wk.register(
  {
    ...
    ["<Leader>res"] = {
      ...
      end, noremap = true, "restore to the state of the last exit" }
  }
)
...
vim.api.nvim_create_autocmd('LspAttach', {
  ...
  callback = function(ev)
    ...
    vim.keymap.set('n', '<Leader>workspace', vim.lsp.buf.add_workspace_folder, opts("vim.lsp.buf.add_workspace_folder"))
